...
return new class extends Migration
{
    public function up()
    {
        ...
        Schema::table('sidemenus', function (Blueprint $table) {
    ...
    $table->json('submenu')->nullable()->after('has_submenu');
        ...
        Schema::create('sidemenu_translations', function (Blueprint $table) {
            createDefaultTranslationsTableFields($table, 'sidemenu');
            $table->string('title', 200)->nullable();
    ...
    public function down()
    {
        ...
        Schema::dropIfExists('sidemenu_translations');
